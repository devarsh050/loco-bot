...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title="Trivia Family",description = 'Connecting to Loco')
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NzAyMjQwOTE0MjE4NjgwMzIw.Xqq6jQ.IIViFTTipnFRo7-w4lK0XZjTlGU')
    loop.run_forever()
